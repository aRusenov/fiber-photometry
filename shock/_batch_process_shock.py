...
out_dir = '/Users/atanas/Documents/workspace/data/analysis/photometry/shock/processed'
data_dir = '/Users/atanas/Documents/workspace/data/analysis/photometry/shock/preprocessed'
...
for id, files in grouped_files.items():
    ...
    subprocess.run([
        'python',
        os.path.join(script_dir, 'shock', 'shock_process.py'),
        '--file',
